...
<template>
  <div class="changes-page p-3 h-full flex flex-col">
    <h2 class="text-sm font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">File Changes</h2>
    ...
    <div v-else class="flex-1 overflow-y-auto space-y-1">
      ...
      >
        ...
        >
          ...
          <span class="font-mono flex-1 truncate text-gray-700 dark:text-gray-300">{{ c.filePath ?? "(unknown path)" }}</span>
