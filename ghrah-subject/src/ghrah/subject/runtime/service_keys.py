...
# 任务归因内核（S3）：facade 与 checker 注册表两个服务键（不改 legacy TASK_STORE 语义）
TASKSTORE_SERVICE = SubjectServiceKey[Any]("taskstore_service")
TASKSTORE_CHECKERS = SubjectServiceKey[Any]("taskstore_checkers")
